                ...
                <div className="row g-4">
                  ...
                  <div className="col-6 col-md-4 col-lg-2 mb-4 mb-lg-0">
                    ...
                    <ul className="list-unstyled footer-links">
                      ...
                      <li><Link to="/weather" className="footer-link">Weather</Link></li>
                    </ul>
                  </div>
                  ...
                  <div className="col-6 col-md-4 col-lg-2 mb-4 mb-lg-0">
                    ...
                    <ul className="list-unstyled footer-links">
                      <li><Link to="/itinerary" className="footer-link">Itinerary</Link></li>
                      <li><Link to="/map" className="footer-link">Maps</Link></li>
                  ...
                  <div className="col-md-4 col-lg-4">
                    ...
                    <ul className="list-unstyled footer-contact">
                      ...
                      <li className="d-flex">
                        ...
                        <span>123 Travel Street, Digital City</span>
                      </li>
                    </ul>
                  </div>
                </div>
