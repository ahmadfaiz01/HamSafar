    ...
    <>
            ...
            <div className="col-lg-6 d-flex align-items-center" style={{ 
              ...
              <div className="hero-content p-4 p-md-5">
                ...
                <div className="d-flex flex-wrap gap-3 animate__animated animate__fadeInUp animate__delay-2s">
                  {currentUser ? (
                    <Link to="/itinerary" className="btn btn-hero btn-lg px-4 py-2">
            ...
            <div className="card h-100 shadow-sm border-0 hover-card">
              <div className="card-body d-flex flex-column p-4">
                ...
                <div className="mt-auto">
                  <Link to="/itinerary" className="btn btn-accent w-100">Get Started</Link>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-4">
            <div className="card h-100 shadow-sm border-0 hover-card">
              <div className="card-body d-flex flex-column p-4">
                ...
                <div className="mt-auto">
                  <Link to="/flights" className="btn btn-accent w-100">Search Flights</Link>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="bg-primary text-white py-5">
        <div className="container text-center py-3">
          ...
          <Link to={currentUser ? "/itinerary" : "/login"} className="btn btn-lg" style={{ backgroundColor: 'var(--accent-color)', color: 'var(--primary-color)' }}>
